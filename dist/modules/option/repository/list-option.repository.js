...
exports.ListOptionRepository = void 0;
const common_1 = require("@nestjs/common");
const prisma_database_1 = require("../../../shared/databases/prisma.database");
let ListOptionRepository = class ListOptionRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async ListOption() {
...
exports.ListOptionRepository = ListOptionRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_database_1.PrismaService])
], ListOptionRepository);
//# sourceMappingURL=list-option.repository.js.map