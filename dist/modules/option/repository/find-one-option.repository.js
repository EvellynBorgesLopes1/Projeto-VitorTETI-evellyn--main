...
exports.FindOneOptionRepository = void 0;
const common_1 = require("@nestjs/common");
const prisma_database_1 = require("../../../shared/databases/prisma.database");
let FindOneOptionRepository = class FindOneOptionRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async findone(id) {
...
exports.FindOneOptionRepository = FindOneOptionRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_database_1.PrismaService])
], FindOneOptionRepository);
//# sourceMappingURL=find-one-option.repository.js.map