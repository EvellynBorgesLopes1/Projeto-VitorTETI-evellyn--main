...
exports.CreateOptionRepository = void 0;
const common_1 = require("@nestjs/common");
const prisma_database_1 = require("../../../shared/databases/prisma.database");
let CreateOptionRepository = class CreateOptionRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(data) {
...
exports.CreateOptionRepository = CreateOptionRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_database_1.PrismaService])
], CreateOptionRepository);
//# sourceMappingURL=create-option.repository.js.map